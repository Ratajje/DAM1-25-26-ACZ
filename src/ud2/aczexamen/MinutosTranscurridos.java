...
public class MinutosTranscurridos {
    public static void main(String[] args) {
        minutosTranscurridos(13, 20, 10, 10);
    }
    ...
    static int minutosTranscurridos(int horaA, int minutoA, int horaB, int minutoB) {
        ...
        int minutosHoraA = horaA * 60 + minutoA; // 13:10 = 790 minutos
        int minutosHoraB = horaB * 60 + minutoB; // 10:20 = 620 minutos

        minutosTranscurridos = (minutosHoraA > minutosHoraB) ? minutosHoraA - minutosHoraB : minutosHoraB - minutosHoraA;
