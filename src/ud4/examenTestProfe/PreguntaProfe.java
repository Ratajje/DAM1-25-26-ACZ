...
public class PreguntaProfe {
    ...
    public PreguntaProfe(String enunciado, String[] respuestas, int respuestaCorrecta) {
    ...
    public boolean equals(PreguntaProfe a, PreguntaProfe b) {
    ...
    public static PreguntaProfe[] cargarFichero(String fichero) {
        String[] preguntasCSV = Util.readFileToStringArray(fichero);

        PreguntaProfe[] preguntas = new PreguntaProfe[preguntasCSV.length];
