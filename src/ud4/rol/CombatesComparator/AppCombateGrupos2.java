...
public class AppCombateGrupos2 {
    ...
    public static void main(String[] args) {
        ...
        // Metemos a todos los personajes en un único array y lo ordenamos
        // descendentemente por agilidad
    ...
    public static void ejecutarAtaque(Personaje atacante, Personaje defensor) {
